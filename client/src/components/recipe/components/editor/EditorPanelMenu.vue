...
<template>
    <div class="editor-panel-menu-container">
        <button title="Bold" @click="editor?.chain().focus().toggleBold().run()" :disabled="!editor?.can().chain().focus().toggleBold().run()" :class="{ 'is-active': editor?.isActive('bold') }">
            <span class="material-symbols-outlined" :class="{ 'active-button': editor?.isActive('bold') }">match_case</span>
        </button>
        <button title="Italic" @click="editor.chain().focus().toggleItalic().run()" :disabled="!editor.can().chain().focus().toggleItalic().run()" :class="{ 'is-active': editor.isActive('italic') }">
            <span class="material-symbols-outlined" :class="{ 'active-button': editor?.isActive('italic') }">format_italic</span>
        </button>
        <button title="Bullet List" @click="editor.chain().focus().toggleBulletList().run()" :class="{ 'is-active': editor.isActive('bulletList') }">
            <span class="material-symbols-outlined" :class="{ 'active-button': editor?.isActive('bulletList') }">format_list_bulleted</span>
        </button>
        <button title="Ordered List" @click="editor.chain().focus().toggleOrderedList().run()" :class="{ 'is-active': editor.isActive('orderedList') }">
            <span class="material-symbols-outlined" :class="{ 'active-button': editor?.isActive('orderedList') }">format_list_numbered</span>
        </button>
